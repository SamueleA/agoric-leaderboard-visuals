...
const TokenPool = () => {
    ...
    const chart = () => {
        ...
        axios
            .get("http://139.59.67.100:1317/cosmos/distribution/v1beta1/community_pool")
            .then(res => {
                console.log(res);
                for (const dataObj of res.data.pool) {
                    combinedArray.push(
                        {
                            value: parseFloat(dataObj.amount).toFixed(2),
                            key: (dataObj.denom)
                        }
                    )
        ...
        <div className="App">
            <div>
                <Doughnut
                    ...
                    options={{
                        responsive: true,
                        title: {text: "Top Tokens In Community Pool", fontSize: 25, display: true},
                        // scales: {
                        //     yAxes: [
                        //         {
                        //             ticks: {
